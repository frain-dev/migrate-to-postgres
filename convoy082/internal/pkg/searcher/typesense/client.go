...
var (
	ErrUidFieldIsNotString = errors.New("uid field should be a string")
	ErrUidFieldIsRequired  = errors.New("uid field does not exist on the document")
)

var (
	ErrCreatedAtFieldIsNotString = errors.New("created_at field should be a string")
	ErrCreatedAtFieldIsRequired  = errors.New("created_at field does not exist on the document")
)

var (
	ErrUpdatedAtFieldIsNotString = errors.New("updated_at field should be a string")
	ErrUpdatedAtFieldIsRequired  = errors.New("updated_at field does not exist on the document")
)
